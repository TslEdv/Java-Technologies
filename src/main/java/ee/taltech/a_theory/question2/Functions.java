...
public class Functions {
    ...
    //  A [false] function is a piece of code that takes in variables and returns an output
    ...
    //  C [false] method names are usually written as verbs
    //  D [false] static methods means that the method returns no value
    ...
    //  G [x] if you want your method to be used by other classes in other packages you declare it as protected
